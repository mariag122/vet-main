                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nome" class="form-control" value="<?= $servico->getNome() ?>">
                        </p>
                        <p class="form-group">
                            <label for="cnpj">Descricao</label>
                            <input type="text" name="descricao" class="form-control" value="<?= $servico->getDescricao() ?>">
                        </p>
                        <p class="form-group">
                            <label for="valor">Valor</label>
                            <input type="text" name="valor" class="form-control" value="<?= $servico->getValor() ?>">
                        </p>
