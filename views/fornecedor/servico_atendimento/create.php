<?php
    ...
    $daoAtendimento = new Atendimento();
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Adicionar Servico à Atendimento</h2>
                    <form action="insert.php" method="post">
                        <p class="form-group">
                            <label for="id">ID do Servico: </label>
                            <strong><?= $idServico ?></strong>
                            <input type="hidden" name="id" value="<?= $idServico ?>">
                        </p>                        
                        <!-- Para a chave estrangeira (associação com Produto) -->
                        <p class="form-group">
                            <label for="Atendimento">Atendimento</label>
                            <select name="atendimento" class="form-control">
                                <?php foreach($daoAtendimento->read() as $atendimento) : ?>
                                    <option value="<?= $Atendimento->getId() ?>"><?= $atendimento->getDataAtendimento() ?></option>
                                <?php endforeach ?>
                            </select>
                        </p>                   
                        <p class="form-group">
